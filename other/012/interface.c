                        ...
                        window)
{
    ...
    rootmenu = gtk_menu_item_new_with_label(g_locale_to_utf8(" 文件 ", 6, NULL, NULL, NULL));
    gtk_widget_show(rootmenu);
    gtk_menu_item_set_submenu(GTK_MENU_ITEM(rootmenu),menu);
    menubar = gtk_menu_bar_new();
    gtk_menu_shell_append(GTK_MENU_SHELL(menubar),rootmenu);
    rootmenu = gtk_menu_item_new_with_label(g_locale_to_utf8(" 编辑 ", 6, NULL, NULL, NULL));
    ...
    gtk_menu_shell_append(GTK_MENU_SHELL(menubar),rootmenu);
    rootmenu = gtk_menu_item_new_with_label(g_locale_to_utf8(" 帮助 ", 6, NULL, NULL, NULL));
    ...
    menuitem = gtk_menu_item_new_with_label(g_locale_to_utf8(" 关于", 6, NULL, NULL, NULL));
    gtk_menu_shell_append(GTK_MENU_SHELL(helpmenu),menuitem);
    g_signal_connect(G_OBJECT(menuitem),"activate",
...
GtkWidget* create_toolbar (GtkWidget* window)
{
    ...
    gtk_toolbar_insert_stock(GTK_TOOLBAR(toolbar),
                             GTK_STOCK_NEW,
                             g_locale_to_utf8("创建一个新文件", 6, NULL, NULL, NULL),
                             g_locale_to_utf8("新建", 6, NULL, NULL, NULL),
                             GTK_SIGNAL_FUNC(on_file_new_activate),
                             window,-1);
    gtk_toolbar_insert_stock(GTK_TOOLBAR(toolbar),
                             GTK_STOCK_OPEN,
                             g_locale_to_utf8("打开一个文件", 6, NULL, NULL, NULL),
                             g_locale_to_utf8("打开", 6, NULL, NULL, NULL),
                             GTK_SIGNAL_FUNC(on_file_open_activate),
                             toolbar,-1);
    gtk_toolbar_insert_stock(GTK_TOOLBAR(toolbar),
                             GTK_STOCK_SAVE,
                             g_locale_to_utf8("保存当前文件", 6, NULL, NULL, NULL),
                             g_locale_to_utf8("保存", 6, NULL, NULL, NULL),
